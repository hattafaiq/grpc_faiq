...
class protokol_1 final {
 public:
  ...
  typedef WithAsyncMethod_initial_data<WithAsyncMethod_kirim_data<Service > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_initial_data<WithCallbackMethod_kirim_data<Service > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_initial_data<WithStreamedUnaryMethod_kirim_data<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_initial_data<WithStreamedUnaryMethod_kirim_data<Service > > StreamedService;
};
