...
protokol_1::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_kirim_data_(protokol_1_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status protokol_1::Stub::kirim_data(::grpc::ClientContext* context, const ::Cloud::mes_client& request, ::Cloud::mes_server* response) {
...
void protokol_1::Stub::async::kirim_data(::grpc::ClientContext* context, const ::Cloud::mes_client* request, ::Cloud::mes_server* response, std::function<void(::grpc::Status)> f) {
...
void protokol_1::Stub::async::kirim_data(::grpc::ClientContext* context, const ::Cloud::mes_client* request, ::Cloud::mes_server* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::Cloud::mes_server>* protokol_1::Stub::PrepareAsynckirim_dataRaw(::grpc::ClientContext* context, const ::Cloud::mes_client& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::Cloud::mes_server>* protokol_1::Stub::Asynckirim_dataRaw(::grpc::ClientContext* context, const ::Cloud::mes_client& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
protokol_1::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      protokol_1_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< protokol_1::Service, ::Cloud::mes_client, ::Cloud::mes_server, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](protokol_1::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status protokol_1::Service::kirim_data(::grpc::ServerContext* context, const ::Cloud::mes_client* request, ::Cloud::mes_server* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
